        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            >
              ...
              <li>Enrolled Student Helpline: +91 7903922507</li>
          ...
          <div>
            ...
            >
              ...
              <li><a href="#" className="text-gray-300 hover:text-white">Admission Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Referral Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Privacy Policy</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Terms of Service</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white">Master FAQs</a></li>
            </motion.ul>
          </div>
        </div>
